...
# Noise-robustness study on the IMPROVED controller_v2 dataset.
# Same protocol as the original noise study: Gaussian sensor noise is added to the
# MEASURED outputs y used in training; evaluation is always vs the TRUE states of
# unseen flights. Config matches our retrained observer: 4x100, weights (0.5,1.5,1.0).
...
print(f"Noise study on {DATASET}, {LAYERS}x{HIDDEN}, weights ({W0},{WODE},{WY})", flush=True)
...
print("Saved docs/noise_study_v2.csv", flush=True)
