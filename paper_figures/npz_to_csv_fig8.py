...
d = np.load('docs/eval_figure8_best_data.npz')
...
np.savetxt('paper_figures/fig_figure8_observer_states.csv', arr,
           delimiter=',', header=','.join(hdr), comments='', fmt='%.6g')
print('wrote paper_figures/fig_figure8_observer_states.csv', arr.shape)
