"""Generate observer dataset from controller_v3 FIGURE-8 flights.
Same 50-flight IC scatter as the circle/spiral generators; controller_v3.
Output: datasets/figure8_v3_dataset.npz.
"""
import sys, os
...
def ctrl(t, x):
    return full_control_v3(t, x, figure8_reference, yaw_reference)
...
if __name__ == "__main__":
    ...
    np.savez("datasets/figure8_v3_dataset.npz", T=T, X=X, U=U)
    print("saved -> datasets/figure8_v3_dataset.npz")
