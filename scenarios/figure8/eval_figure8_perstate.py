# -*- coding: utf-8 -*-
# FIGURE-8: per-state RMSE POOLED over all 10 unseen test flights, best config.
# Run from repo root (cluster):
#   module load pytorch/2.0.0/gpu
#   nohup python3 scenarios/figure8/eval_figure8_perstate.py >> figure8_perstate_log.txt 2>&1 &
import sys, os
ROOT = os.getcwd()
...
LAYERS, HIDDEN = 9, 100
W0, WODE, WY = 1.0, 1.0, 1.0                 # best figure-8 weights (Case 1, neutral)
