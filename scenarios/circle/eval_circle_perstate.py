# -*- coding: utf-8 -*-
# CIRCLE: per-state RMSE POOLED over all 10 unseen test flights, best config.
# Run from repo root (cluster):
#   module load pytorch/2.0.0/gpu
#   nohup python3 scenarios/circle/eval_circle_perstate.py >> circle_perstate_log.txt 2>&1 &
import sys, os
ROOT = os.getcwd()
...
LAYERS, HIDDEN = 4, 100
W0, WODE, WY = 0.5, 0.5, 1.0                 # best circle weights (Case 3)
