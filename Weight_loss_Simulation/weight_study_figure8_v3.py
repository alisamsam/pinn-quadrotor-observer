...
# Loss-weight sweep (7 cases) for the FIGURE-8 observer at its best architecture: 9 x 100.
EPOCHS, LR, BATCH, LOG_EVERY = 2000, 1e-3, 4096, 500
LAYERS, HIDDEN = 9, 100
SEED = 0
DATASET = "datasets/figure8_v3_dataset.npz"
CSV_PATH = "docs/weight_study_figure8_v3.csv"
CASES = [(1.0,1.0,1.0),(0.5,1.5,1.0),(0.5,0.5,1.0),(1.0,2.0,1.0),(2.0,1.0,1.0),(2.0,1.0,0.5),(2.0,1.5,1.5)]

device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
print("Device:", device, "| dataset:", DATASET, "| weight sweep @ 9x100", flush=True)
