"""Evaluate observer on the Singha-scenario flight, all 12 states."""
import sys, os
...
m = PINNObserver(); m.load_state_dict(torch.load("models/pinn_singha.pth")); m.eval()
with torch.no_grad():
...
fig.suptitle("Singha scenario: observer on all 12 states", fontsize=15)
fig.tight_layout(rect=[0,0,1,0.98])
os.makedirs("docs", exist_ok=True)
plt.savefig("docs/eval_singha.png", dpi=110, bbox_inches="tight")
print("Saved -> docs/eval_singha.png")