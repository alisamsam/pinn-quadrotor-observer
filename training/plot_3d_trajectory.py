"""Phase 2: 3D trajectory plot — true vs estimated path through space."""
import sys, os
...
ax.set_title("Phase 2: 3D flight path — true vs observer estimate")
ax.legend()

os.makedirs("docs", exist_ok=True)
plt.savefig("docs/trajectory_3d.png", dpi=120, bbox_inches="tight")
print("Saved -> docs/trajectory_3d.png")