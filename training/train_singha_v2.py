"""Singha training v2: bigger network + more epochs to capture transients."""
import sys, os
...
torch.manual_seed(0)
N_EPOCHS = 500            # was 200 -> more practice
...
# BIGGER network: 3 layers x 128 neurons (was 2 x 64)
model = PINNObserver(hidden=128, n_hidden_layers=3)
opt = torch.optim.Adam(model.parameters(), lr=LR)

print("Network: 3 x 128 | Epochs: 500")
...
torch.save(model.state_dict(), "models/pinn_singha_v2.pth")
print("\nSaved -> models/pinn_singha_v2.pth")