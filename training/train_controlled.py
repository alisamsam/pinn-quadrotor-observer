"""B.7: train observer on the rich controlled dataset."""
import sys, os
...
data = np.load("datasets/controlled_dataset.npz")       # <-- rich controlled data
...
torch.save(model.state_dict(), "models/pinn_controlled.pth")
print("\nSaved -> models/pinn_controlled.pth")