...
# Train the validated 4x100 observer on the CIRCLE controller_v2 dataset.
# Identical to train_4x100_v2.py (spiral); only DATASET and SAVE_PATH differ.
EPOCHS, LR, BATCH, LOG_EVERY = 2000, 1e-3, 4096, 100
LAYERS, HIDDEN = 4, 100
W0, WODE, WY = 0.5, 1.5, 1.0
SEED = 0
DATASET = "datasets/circle_v2_dataset.npz"
SAVE_PATH = "phase1a/pinn_4x100_circle_v2.pth"
