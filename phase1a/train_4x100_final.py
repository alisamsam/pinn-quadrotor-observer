...
# Final 4x100 model, best 4x100 weights (Case 2 of the 4x100 sweep).
EPOCHS, LR, BATCH, LOG_EVERY = 2000, 1e-3, 4096, 100
LAYERS, HIDDEN = 4, 100
W0, WODE, WY = 0.5, 1.5, 1.0
SEED = 0
SAVE_PATH = "phase1a/pinn_4x100.pth"

device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
print("Device:", device, flush=True)
print(f"Training {LAYERS}x{HIDDEN}, weights ({W0},{WODE},{WY})", flush=True)
